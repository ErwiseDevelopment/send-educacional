...
<main class="bg-slate-50 min-h-screen pt-32 pb-20">
    <div class="container mx-auto px-6 max-w-4xl">
        <div class="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-200 shadow-sm">
            <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 mb-8">Política de Privacidade e <span class="text-blue-600">LGPD</span></h1>
            
            <div class="prose prose-slate max-w-none text-slate-600 space-y-6 text-sm md:text-base leading-relaxed">
                ...
                <h2 class="text-xl font-bold text-slate-800 pt-4">1. Coleta de Dados</h2>
                ...
                <h2 class="text-xl font-bold text-slate-800 pt-4">2. Finalidade do Tratamento</h2>
                ...
                <h2 class="text-xl font-bold text-slate-800 pt-4">3. Segurança e Armazenamento</h2>
                ...
                <h2 class="text-xl font-bold text-slate-800 pt-4">4. Seus Direitos</h2>
