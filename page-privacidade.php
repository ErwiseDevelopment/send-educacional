...
<main class="min-h-screen pt-32 pb-20">
    <div class="container mx-auto px-6 max-w-4xl">
        <div class="glass reveal p-8 md:p-12 rounded-[2.5rem]">
            <h1 class="text-3xl md:text-4xl font-extrabold txt-forte mb-8">Política de Privacidade e <span class="gtext">LGPD</span></h1>

            <div class="prose prose-invert max-w-none txt space-y-6 text-sm md:text-base leading-relaxed">
                ...
                <h2 class="text-xl font-bold txt-forte pt-4">1. Coleta de Dados</h2>
                ...
                <h2 class="text-xl font-bold txt-forte pt-4">2. Finalidade do Tratamento</h2>
                ...
                <h2 class="text-xl font-bold txt-forte pt-4">3. Segurança e Armazenamento</h2>
                ...
                <h2 class="text-xl font-bold txt-forte pt-4">4. Seus Direitos</h2>
                ...
                <p class="text-xs txt mt-10">Última atualização: <?php echo date('d/m/Y'); ?></p>
            </div>
        </div>
    </div>
</main>
