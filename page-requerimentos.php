...
<main class="min-h-screen">
    ...
    <section class="sup-escura pt-32 pb-24 border-b border-slate-800 relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 max-w-5xl relative z-10">
            ...
            <div class="sup-escura inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800 border border-slate-700 shadow-sm text-xs font-semibold text-orange-400 mb-6 uppercase tracking-wider">
        ...
        <div class="container mx-auto px-6 max-w-5xl">
            <div class="glass rounded-2xl p-8 flex flex-col md:flex-row justify-around items-center divide-y md:divide-y-0 md:divide-x divide-white/10">
                <div class="text-center p-4 w-full">
                    ...
                    <p class="text-sm font-semibold txt uppercase tracking-wide">Fluxos Automatizados</p>
                </div>
                <div class="text-center p-4 w-full">
                    <p class="text-3xl font-extrabold gtext mb-1">SLA</p>
                    <p class="text-sm font-semibold txt uppercase tracking-wide">Gestão de Prazos (SLA)</p>
                </div>
                <div class="text-center p-4 w-full">
                    <p class="text-3xl font-extrabold gtext mb-1">360º</p>
                    <p class="text-sm font-semibold txt uppercase tracking-wide">Performance por Equipe</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 relative z-20">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-black txt-forte mb-4 tracking-tight">Atendimento Nível Enterprise</h2>
                <p class="text-lg txt">Esqueça tickets em softwares genéricos. Nosso módulo é construído no coração dos dados do aluno.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Workflow Inteligente</h3>
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Atendimento ao Aluno</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden">
                    <div class="w-16 h-16 bg-bloco border linha text-amber-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Comunicação Ativa</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Produtividade de Equipes</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
    ...
    <section class="py-32 sup-escura text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 class="text-4xl md:text-6xl font-black txt-forte mb-8 tracking-tighter">Eleve a régua do <span class="text-orange-400">Atendimento ao Aluno.</span></h2>
