...
<main class="bg-slate-50 min-h-screen flex items-center justify-center py-20 relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center max-w-3xl">
        ...
        <div class="max-w-xl mx-auto mb-12">
            <form role="search" method="get" action="<?php echo home_url( '/' ); ?>" class="relative shadow-lg rounded-2xl group">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 txt group-focus-within:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button onclick="abrirDemo()" class="sup-escura w-full sm:w-auto px-8 py-4 rounded-xl font-bold txt-forte bg-blue-600 hover:bg-blue-700 shadow-[0_8px_30px_rgb(37,99,235,0.3)] hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
