...
<main class="min-h-screen">
        ...
        <div class="container mx-auto px-6 max-w-5xl">
            <div class="glass rounded-2xl p-8 flex flex-col md:flex-row justify-around items-center divide-y md:divide-y-0 md:divide-x divide-white/10">
                <div class="text-center p-4 w-full">
                    <p class="text-3xl font-extrabold text-emerald-300 mb-1">360º</p>
                    <p class="text-sm font-semibold text-slate-400 uppercase tracking-wide">Pagar & Receber Integrados</p>
                </div>
                <div class="text-center p-4 w-full">
                    <p class="text-3xl font-extrabold text-emerald-300 mb-1">Zero</p>
                    <p class="text-sm font-semibold text-slate-400 uppercase tracking-wide">Digitação de NF-e</p>
                </div>
                <div class="text-center p-4 w-full">
                    <p class="text-3xl font-extrabold text-emerald-300 mb-1">Self-Service</p>
                    <p class="text-sm font-semibold text-slate-400 uppercase tracking-wide">Acordos e Negociações</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 relative z-20">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-black text-white mb-4 tracking-tight">Pare de correr atrás de pagamentos</h2>
                <p class="text-lg text-slate-400">Transforme a sua equipe financeira de "cobradores" em analistas estratégicos de receita e despesa.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-emerald-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold text-white mb-6">Contas a Receber</h3>
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-rose-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold text-white mb-6">Contas a Pagar</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-cyan-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold text-white mb-6">Automação Fiscal (NF-e)</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-indigo-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold text-white mb-6">Polos & Repasses</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-pink-300 rounded-2xl flex items-center justify-center mb-8">
                    ...
                    <h3 class="text-2xl font-extrabold text-white mb-6">Bolsas & Convênios</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-blue-300 rounded-2xl flex items-center justify-center mb-8">
                    ...
                    <h3 class="text-2xl font-extrabold text-white mb-6">BI & Orçamento</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
    ...
    <section class="py-32 bg-slate-900 text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 class="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter">Acabe com a fuga de receitas <span class="gtext">hoje mesmo.</span></h2>
