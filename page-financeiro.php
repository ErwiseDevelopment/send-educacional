    ...
    <section class="py-24 relative z-20">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="sup-escura bg-slate-900 rounded-[2.5rem] border border-slate-700 p-10 shadow-2xl hover:border-emerald-400 transition-all duration-500 group relative overflow-hidden">
                    ...
                    <div class="w-16 h-16 bg-emerald-500 txt-forte rounded-2xl flex items-center justify-center mb-8 shadow-md">
