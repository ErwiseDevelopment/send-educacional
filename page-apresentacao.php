...
<a href="<?php echo esc_url( se_whatsapp_link( 'Olá! Estou na apresentação do Send Educacional e gostaria de falar com um especialista.' ) ); ?>"
   ...
   class="fixed bottom-6 right-6 z-[90] bg-[#25D366] p-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,.45)] hover:-translate-y-1 transition-all" aria-label="Falar no WhatsApp">
