...
<main class="min-h-screen">
    ...
    <section class="sup-escura pt-32 pb-24 border-b border-slate-800 relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 max-w-5xl relative z-10">
            <div class="flex justify-center items-center space-x-2 text-sm txt mb-6 font-medium uppercase tracking-widest">
                <a href="<?php echo home_url(); ?>" class="hover:txt-link transition">Início</a>
                <span>/</span>
                <span class="text-blue-500">O Ecossistema Acadêmico</span>
            </div>

            <div class="sup-escura inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800 border border-slate-700 shadow-sm text-xs font-semibold txt-link mb-6 uppercase tracking-wider">
    ...
    <section class="py-24 relative z-20">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-black txt-forte mb-4 tracking-tight">O Fim das Planilhas Paralelas</h2>
                <p class="text-lg txt">Conheça o arsenal completo que a sua Secretaria Acadêmica terá à disposição.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-blue-600/10 rounded-full blur-3xl -mr-10 -mt-10 group-hover:bg-blue-600/20 transition-colors"></div>
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Matrículas & Notas</h3>
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">MEC, Censo e Diplomas</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-bloco border linha text-orange-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Gestão Institucional</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-bloco border linha text-purple-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Atendimento & Portal</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Secretaria Virtual para o Aluno (24h)</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Abertura e Triagem de Solicitações e Protocolos</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Envio e Validação de Atividades Complementares</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Atendimento Dedicado a Polos (EAD)</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Histórico Centralizado de Comunicações</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Mural de Recados Institucional</li>
                        <li class="flex items-start gap-3"><span class="text-purple-300 mt-0.5">✓</span> Envio Automático de Mensageria (E-mails Dinâmicos)</li>
                    </ul>
                </div>
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <h3 class="text-2xl font-extrabold txt-forte mb-6">Relatórios (BI)</h3>
                    <ul class="space-y-4 txt text-sm font-medium">
    ...
    <section class="py-32 sup-escura text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            <h2 class="text-4xl md:text-6xl font-black txt-forte mb-8 tracking-tighter">Pronto para operar no <span class="gtext">nível máximo?</span></h2>
