    ...
    <section class="py-24 relative z-20">
        <div class="container mx-auto px-6 max-w-7xl">
            ...
            <div class="text-center mb-16 reveal">
                <h2 class="text-4xl font-black text-white mb-4 tracking-tight">O Fim das Planilhas Paralelas</h2>
                <p class="text-lg text-slate-400">Conheça o arsenal completo que a sua Secretaria Acadêmica terá à disposição.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <h3 class="text-2xl font-extrabold text-white mb-6">Matrículas & Notas</h3>
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <h3 class="text-2xl font-extrabold text-white mb-6">MEC, Censo e Diplomas</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    ...
                    <h3 class="text-2xl font-extrabold text-white mb-6">Gestão Institucional</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
                ...
                <div class="glass glass-hover rounded-[2.5rem] p-10 transition-all duration-500 group relative overflow-hidden reveal">
                    <div class="w-16 h-16 bg-white/5 border border-white/10 text-purple-300 rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-extrabold text-white mb-6">Atendimento & Portal</h3>
                    <ul class="space-y-4 text-slate-400 text-sm font-medium">
