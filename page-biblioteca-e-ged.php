...
<main class="bg-slate-50 min-h-screen">
    ...
    <section class="bg-slate-900 pt-32 pb-24 border-b border-slate-800 relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
                Biblioteca & <span class="text-blue-500">GED Digital</span>
            </h1>
    ...
    <section class="py-20">
        <div class="container mx-auto px-6">
            <div class="flex items-center gap-4 mb-12">
                ...
                <h2 class="text-3xl font-bold text-slate-900 tracking-tight">Gestão de Documentos (GED)</h2>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Importação e Armazenamento</h3>
                    <p class="text-slate-500 leading-relaxed text-sm">Centralize todos os documentos da instituição em nuvem segura, com organização automática por pastas e categorias.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Assinatura Digital</h3>
                    <p class="text-slate-500 leading-relaxed text-sm">Formalize contratos e documentos acadêmicos com validade jurídica, eliminando a necessidade de impressões e deslocamentos.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-3">Consulta e Validação</h3>
                    <p class="text-slate-500 leading-relaxed text-sm">Ferramentas de busca avançada e validação de autenticidade para garantir a integridade dos dados institucionais.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-slate-100/50">
        <div class="container mx-auto px-6">
            <div class="flex items-center gap-4 mb-12">
                ...
                <h2 class="text-3xl font-bold text-slate-900 tracking-tight">Biblioteca Física</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Cadastro detalhado de exemplares, controle de autores e categorização inteligente do acervo.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Gestão de empréstimos e devoluções com notificações automáticas para alunos e professores.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Geração de etiquetas para organização física e sistema automático de cobrança de multas por atraso.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed">Relatórios gerenciais completos sobre o uso da biblioteca e status de toda a documentação GED.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-900 text-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-3xl relative z-10">
            ...
            <button onclick="document.getElementById('demo-modal').classList.remove('hidden')" class="bg-blue-600 hover:bg-blue-500 text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all shadow-lg hover:scale-105">
