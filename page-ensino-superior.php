...
<main class="relative overflow-hidden">
    ...
    <section class="sup-clara-2 relative pt-20 pb-16 overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-4xl text-center relative z-10">
            <div class="flex justify-center items-center gap-2 text-xs txt mb-7 font-semibold uppercase tracking-widest">
                ...
                <span style="color:<?php echo esc_attr( $se_cor_t ); ?>">Ensino Superior</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                <button data-track="cta-hero-ensino-superior" onclick="abrirDemo('ensino-superior')" class="gbtn txt-forte font-bold px-8 py-4 rounded-2xl text-lg w-full sm:w-auto transition-all hover:-translate-y-0.5">Solicitar demonstração</button>
                <a href="#catalogo" class="w-full sm:w-auto px-8 py-4 rounded-2xl text-lg font-semibold txt-forte glass hover:bg-white/10 transition">Ver o catálogo completo</a>
            </div>
            <p class="txt-fraco text-sm mt-5">Demonstração gratuita · sem compromisso · com um especialista em ensino superior</p>
        </div>
    </section>
    ...
    <section class="relative py-16">
        <div class="container mx-auto px-6 max-w-6xl">
            <div class="text-center mb-10 reveal">
                <span class="font-bold tracking-widest uppercase text-xs" style="color:<?php echo esc_attr( $se_cor_t ); ?>">Regulação sem susto</span>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 reveal">
                <?php foreach ( array(
                    ...
                    printf(
                        '<div class="glass glass-hover rounded-3xl p-7"><div class="w-11 h-11 rounded-xl flex items-center justify-center mb-5" style="background:%s22;border:1px solid %s55"><svg class="w-5 h-5" style="color:%s" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><h3 class="titulo-mini txt-forte text-lg mb-2">%s</h3><p class="txt text-sm leading-relaxed">%s</p></div>',
                        esc_attr( $se_cor ), esc_attr( $se_cor ), esc_attr( $se_cor_t ), esc_html( $r[0] ), esc_html( $r[1] )
                    );
                } ?>
            </div>
        </div>
    ...
    <section class="relative py-20">
        <div class="container mx-auto px-6 max-w-6xl grid lg:grid-cols-2 gap-14 items-center reveal">
            <div>
                <span class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glass text-[11px] font-bold uppercase tracking-widest mb-5" style="color:<?php echo esc_attr( $se_cor_t ); ?>">AVA próprio</span>
                ...
                <button data-track="cta-ava-superior" onclick="abrirDemo('ensino-superior')" class="gbtn txt-forte font-bold px-7 py-3.5 rounded-2xl transition-all hover:-translate-y-0.5">Ver o AVA na demonstração</button>
            </div>

            <div class="glass rounded-3xl p-8 cardring">
                <p class="text-xs font-bold uppercase tracking-widest mb-6" style="color:<?php echo esc_attr( $se_cor_t ); ?>">A jornada acadêmica, ponta a ponta</p>
                <ol class="space-y-5">
                    <?php
                    $es_jornada = array(
    ...
    <section class="relative py-20">
        <div class="container mx-auto px-6 max-w-5xl">
            <div class="glass rounded-[2.5rem] p-10 md:p-14 text-center cardring reveal">
                ...
                <p class="text-lg txt max-w-2xl mx-auto mb-8">A gente parte do seu processo seletivo, da sua secretaria e da sua cobrança, para mostrar onde cada um deles vive dentro do sistema.</p>
                <button data-track="cta-final-ensino-superior" onclick="abrirDemo('ensino-superior')" class="gbtn txt-forte font-bold px-9 py-4 rounded-2xl text-lg transition-all hover:-translate-y-0.5">Solicitar demonstração</button>
                <p class="txt-fraco text-sm mt-4">Gratuita · sem compromisso · com um especialista em ensino superior</p>
            </div>
