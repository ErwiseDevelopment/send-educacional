    ...
    <section class="bg-slate-900 pt-32 pb-20 relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <h1 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
                Ecossistema <span class="text-blue-500">Send Educacional</span>
            </h1>
    ...
    <section class="py-24 relative z-10">
        <div class="container mx-auto px-6 max-w-7xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-blue-200 transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">Gestão Acadêmica</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/gestao-academica'); ?>" class="inline-flex items-center font-bold text-blue-600 hover:text-blue-700 group-hover:translate-x-1 transition-transform">
                ...
                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-emerald-200 transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">Gestão Financeira</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/gestao-financeira'); ?>" class="inline-flex items-center font-bold text-emerald-600 hover:text-emerald-700 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>

                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-orange-200 transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">Central de Requerimentos</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/requerimentos'); ?>" class="inline-flex items-center font-bold text-orange-600 hover:text-orange-700 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>

                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-indigo-200 transition-all duration-300 group flex flex-col">
                    <div class="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477-4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    </div>
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">Biblioteca & GED</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/biblioteca-e-ged'); ?>" class="inline-flex items-center font-bold text-indigo-600 hover:text-indigo-700 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>

                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-cyan-200 transition-all duration-300 group flex flex-col">
                    <div class="w-14 h-14 bg-cyan-50 text-cyan-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-cyan-600 group-hover:text-white transition-all">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">Portais e App Mobile</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/portais'); ?>" class="inline-flex items-center font-bold text-cyan-600 hover:text-cyan-700 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>

                <div class="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:border-pink-200 transition-all duration-300 group flex flex-col">
                    <div class="w-14 h-14 bg-pink-50 text-pink-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-pink-600 group-hover:text-white transition-all">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 mb-4 tracking-tight">BI & Visões Gerenciais</h3>
                    <p class="text-slate-600 mb-8 leading-relaxed text-sm flex-grow">
    ...
    <section class="py-32 bg-slate-900 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 max-w-7xl relative z-10">
            <div class="text-center mb-20">
                ...
                <h2 class="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">Capte novos alunos. <span class="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Blinde os atuais.</span></h2>
