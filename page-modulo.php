...
<main class="min-h-screen">
    ...
    <section class="sup-escura pt-32 pb-20 relative overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <h1 class="reveal text-4xl md:text-6xl font-black txt-forte mb-6 tracking-tight">
                Ecossistema <span class="gtext">Send Educacional</span>
            </h1>
            <p class="text-xl txt max-w-2xl mx-auto leading-relaxed font-light">
        ...
        <div class="container mx-auto px-6 max-w-7xl">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    <div class="w-14 h-14 bg-bloco border linha txt-link rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-all">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">Gestão Acadêmica</h3>
                    ...
                    <a href="<?php echo home_url('/gestao-academica'); ?>" class="inline-flex items-center font-bold txt-link hover:text-blue-200 group-hover:translate-x-1 transition-transform">
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">Gestão Financeira</h3>
                    <p class="txt mb-8 leading-relaxed text-sm flex-grow">
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">Central de Requerimentos</h3>
                    <p class="txt mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/requerimentos'); ?>" class="inline-flex items-center font-bold txt-link hover:text-blue-200 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">Biblioteca & GED</h3>
                    <p class="txt mb-8 leading-relaxed text-sm flex-grow">
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">Portais e App Mobile</h3>
                    <p class="txt mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <a href="<?php echo home_url('/portais'); ?>" class="inline-flex items-center font-bold txt-link hover:text-blue-200 group-hover:translate-x-1 transition-transform">
                        Conhecer módulo <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M9 5l7 7-7 7"></path></svg>
                    </a>
                </div>
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] transition-all duration-300 group flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold txt-forte mb-4 tracking-tight">BI & Visões Gerenciais</h3>
                    <p class="txt mb-8 leading-relaxed text-sm flex-grow">
                    ...
                    <div class="inline-flex items-center font-bold txt mt-auto">
    ...
    <section class="py-32 sup-escura relative overflow-hidden">
        <div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(#4a78b0 1px, transparent 1px); background-size: 40px 40px;"></div>
        ...
        <div class="container mx-auto px-6 max-w-7xl relative z-10">
            <div class="text-center mb-20">
                <span class="sup-escura inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800 border border-slate-700 txt-link font-bold tracking-[0.2em] text-[10px] uppercase mb-6">
                    Módulos Avançados de Crescimento
                </span>
                <h2 class="text-4xl md:text-5xl font-black txt-forte mb-6 tracking-tight">Capte novos alunos. <span class="gtext">Blinde os atuais.</span></h2>
                <p class="txt max-w-2xl mx-auto text-lg font-light leading-relaxed">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="sup-escura bg-slate-800/40 backdrop-blur-md p-10 md:p-12 rounded-[3rem] border border-slate-700 hover:border-blue-500 hover:bg-slate-800 transition-all duration-500 group flex flex-col">
                    <div class="w-16 h-16 bg-blue-500/20 border border-blue-500/30 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-blue-900/50">
                        <svg class="w-8 h-8 txt-link" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    </div>
                    <h3 class="text-3xl font-extrabold txt-forte mb-4">CRM de Captação</h3>
                    <p class="txt leading-relaxed mb-8 flex-grow">
                    ...
                    <a href="<?php echo home_url('/captacao'); ?>" class="inline-flex items-center font-bold txt-link hover-link group-hover:translate-x-1 transition-transform">
                ...
                <div class="sup-escura bg-slate-800/40 backdrop-blur-md p-10 md:p-12 rounded-[3rem] border border-slate-700 hover:border-violet-500 hover:bg-slate-800 transition-all duration-500 group flex flex-col">
                    ...
                    <h3 class="text-3xl font-extrabold txt-forte mb-4">Retenção e Sucesso</h3>
                    <p class="txt leading-relaxed mb-8 flex-grow">
