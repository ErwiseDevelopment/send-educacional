...
<main class="min-h-screen">
    ...
    <section class="bg-slate-900 pt-32 pb-32 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[11px] font-bold mb-8 uppercase tracking-[0.2em]">
                Desde 1994 transformando processos
            </div>
            <h1 class="reveal text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-tight">
                Experiência que gera <br>
                <span class="gtext">resultados reais.</span>
            </h1>
            <p class="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-light">
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="space-y-6 text-slate-400 text-lg leading-relaxed">
                        ...
                        <div class="glass flex items-center gap-6 p-6 rounded-3xl mt-8">
                            <div class="gbtn text-white p-4 rounded-2xl">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            </div>
                            <div>
                                <h4 class="font-bold text-white text-sm uppercase">Implantação Consultiva</h4>
                                <p class="text-sm text-slate-400 leading-tight">Levantamento de processos real antes de qualquer configuração.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] group hover:-translate-y-2 transition-all duration-300">
                    <div class="w-14 h-14 bg-white/5 border border-white/10 text-blue-300 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-bold text-white mb-4">Missão</h3>
                    <p class="text-slate-400 text-sm leading-relaxed">Transformar o cenário educacional através de tecnologias avançadas, fornecendo ferramentas que garantam a evolução contínua das instituições.</p>
                </div>
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] group hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Ser o sistema de gestão de referência no Brasil, reconhecido pela robustez técnica e pelo atendimento humano e dedicado.</p>
                </div>
                ...
                <div class="glass glass-hover reveal p-10 rounded-[2.5rem] group hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Ética, comprometimento com o cliente, inovação tecnológica constante e foco absoluto em resultados operacionais.</p>
                </div>
